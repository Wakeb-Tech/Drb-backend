...
<?php $__env->startSection('content'); ?>
        <div class="box-header">
            ...
            <a href="<?php echo e(route('cities.create')); ?>" class="fa fa-plus-circle" style="float: right">Add Event City </a>
            <p>Total Event City : <span style="color: #1d68a7"><?php echo e($cities_count); ?></span></p>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <td><?php echo e($city->name_en); ?></td>
                        ...
                        <td>
                            <a href="<?php echo e(route('cities.edit', $city->id)); ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> Edit </a>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel/resources/views/cities/index.blade.php ENDPATH**/ ?>