...
<?php $__env->startSection('bread'); ?>
    <li class="active" style="color: white;font-size: larger">Manage Event Topics</li>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
        <div class="box-header">
            <h1 style="color: blue;" class="box-title">Manage Event Topics</h1>
            <a href="<?php echo e(route('topics.create')); ?>" class="fa fa-plus-circle" style="float: right">Add Event Topic </a>
            <p>Total Event Topics : <span style="color: #1d68a7"><?php echo e($topics_count); ?></span></p>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <?php $__currentLoopData = $topics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e($topic->id); ?>

                        <td><?php echo e($topic->name_ar); ?>

                        <td><?php echo e($topic->name_en); ?></td>
                        </td>
                  
                        <td>
                            <a href="<?php echo e(route('topics.edit', $topic->id)); ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> Edit </a>
                            <form action="<?php echo e(route('topics.destroy', $topic->id)); ?>" method="post" style="display: inline-block">
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel/resources/views/topics/index.blade.php ENDPATH**/ ?>