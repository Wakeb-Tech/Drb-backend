    ...
    <div class="login-box-body">
        ...
        <form action="<?php echo e(route('login')); ?>" method="post">
            ...
            <div class="form-group <?php echo e($errors->has('password')? 'has error':''); ?> has-feedback">
                <input type="password" id="password" name="password" value="<?php echo e(old('password')); ?>" class="form-control" placeholder="Password">
...
<?php /**PATH /var/www/laravel/resources/views/admin/login.blade.php ENDPATH**/ ?>