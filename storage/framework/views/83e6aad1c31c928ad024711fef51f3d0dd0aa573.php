...
<?php $__env->startSection('bread'); ?>
    <li class="active" style="color: white;font-size: larger">Manage Event Country</li>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
        <div class="box-header">
            <h1 style="color: blue;" class="box-title">Manage Event Country</h1>
            <a href="<?php echo e(route('locations.create')); ?>" class="fa fa-plus-circle" style="float: right">Add Event Country </a>
            <p>Total Event Country : <span style="color: #1d68a7"><?php echo e($locations_count); ?></span></p>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e($country->name_ar); ?></td>
                        <td><?php echo e($country->name_en); ?></td>
                    
                  
                        <td>
                            <a href="<?php echo e(route('locations.edit', $country->id)); ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> Edit </a>
                            <form action="<?php echo e(route('locations.destroy', $country->id)); ?>" method="post" style="display: inline-block">
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel/resources/views/locations/index.blade.php ENDPATH**/ ?>