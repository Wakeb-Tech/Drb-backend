...
<?php $__env->startSection('bread'); ?>
    <li class="active" style="color: white;font-size: larger">Manage Categories</li>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
        <div class="box-header">
            <h1 style="color: blue;" class="box-title">Manage Categories</h1>
            <a href="<?php echo e(route('categories.create')); ?>" class="fa fa-plus-circle" style="float: right">Add Category </a>
            <p>Total Categories : <span style="color: #1d68a7"><?php echo e($categories_count); ?></span></p>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e($category->name_ar); ?>

                        <td><?php echo e($category->name_en); ?></td>
                        </td>
                        <td><?php echo e($category->desc_ar); ?></td>
                        <td><?php echo e($category->desc_en); ?></td>
                        <td>
                            <a href="<?php echo e(route('categories.edit', $category->id)); ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> Edit </a>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel/resources/views/categories/index.blade.php ENDPATH**/ ?>