...
{{--            </li>--}}
            ...
            <li style="color: white" class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a style="color: white" href="{{route('categories.index')}}"><i class="fa fa-tasks  "></i> <span>Manage Event Categories  </span></a></li>

                    <li><a style="color: white" href="{{route('locations.index')}}"><i class="fa fa-tasks  "></i> <span>Manage Event Country  </span></a></li>
                    <li><a style="color: white" href="{{route('cities.index')}}"><i class="fa fa-tasks  "></i> <span>Manage Event City  </span></a></li>
                    <li><a style="color: white" href="{{route('topics.index')}}"><i class="fa fa-tasks  "></i> <span>Manage Event Topics  </span></a></li>
                    <li><a style="color: white" href="{{route('events.index')}}"><i class="fa fa-calendar  "></i> <span>Manage Events   </span></a></li>
