...
@section('content')
        <div class="box-header">
            ...
            <a href="{{route('categories.create')}}" class="fa fa-plus-circle" style="float: right">Add Category </a>
            <p>Total Categories : <span style="color: #1d68a7">{{$categories_count}}</span></p>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
