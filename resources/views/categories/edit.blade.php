...
@endsection
@section('bread')
    <li><a href="{{route('categories.index')}}" style="color: white">Manage Categories</a></li>
    <li class="active" style="color: white;font-size: larger"> Edit  Category </li>
@endsection
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" action="{{ route('categories.update', ['id'=>$categories->id]) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="name_ar" class="form-control" id="name_ar"
                                   placeholder="Description" value="{{$categories->name_ar}}">
                        </div>
