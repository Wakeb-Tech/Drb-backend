...
@section('js')
        ...
        function initMap() {
            ...
            google.maps.event.addListener(marker, 'dragend', function (event) {
                ...
                var urlTo = "https://maps.googleapis.com/maps/api/geocode/json?latlng=" + latitude + "," +
                    longitude + "&key=AIzaSyCNeP4vlmQ8y_Sq7EtKk8_mEN47PapWIuI&sensor=true&language=ar";
                $.ajax({
                    url: [urlTo],
                    cache: false,
    ...
    <script async defer
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCNeP4vlmQ8y_Sq7EtKk8_mEN47PapWIuI&callback=initMap&libraries=places">
    </script>
