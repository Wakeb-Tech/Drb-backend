...
@section('content')
        <div class="box-header">
            ...
            <a href="{{route('locations.create')}}" class="fa fa-plus-circle" style="float: right">Add Event Country </a>
            <p>Total Event Country : <span style="color: #1d68a7">{{$locations_count}}</span></p>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                @foreach($countries as $country)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('locations.edit', $country->id) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> Edit </a>
                            <form action="{{ route('locations.destroy', $country->id) }}" method="post" style="display: inline-block">
                            {{ csrf_field() }}
                            {{ method_field('delete') }}
