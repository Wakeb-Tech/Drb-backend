...
@section('content')
        <div class="box-header">
            ...
            <a href="{{route('events.create')}}" class="fa fa-plus-circle" style="float: right">Add Event </a>
            <p>Total events : <span style="color: #1d68a7">{{$events_count}}</span></p>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
                ...
                @foreach($events as $event)
                    <tr>
                        ...
                        <td>
                            ...
                            @if($file->type == 'image')
                            <img src="{{url($file->file)}}" width="50" height="50" class="img-thumbnail">
                            @endif
                            @endforeach
                        </td>
                        <td>
                            <a href="{{ route('events.edit', $event->id) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> Edit </a>
