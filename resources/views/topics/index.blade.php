...
@section('content')
        <div class="box-header">
            ...
            <a href="{{route('topics.create')}}" class="fa fa-plus-circle" style="float: right">Add Event Topic </a>
            <p>Total Event Topics : <span style="color: #1d68a7">{{$topics_count}}</span></p>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                @foreach($topics as $topic)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('topics.edit', $topic->id) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> Edit </a>
