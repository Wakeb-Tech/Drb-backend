...
class UserResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            "bio" => $this->bio,
            "status" => $this->status,
            "accountPrivacy" => $this->accountPrivacy == '1' ? true : false,
            "phonePrivacy" => $this->phonePrivacy == '1' ? true : false,
            "emailPrivacy" => $this->emailPrivacy == '1' ? true : false,
            "followPrivacy" => $this->followPrivacy == '1' ? true : false,
