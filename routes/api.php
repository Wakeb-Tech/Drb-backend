...
], function()
{
    ...
    Route::post('socialLogin', 'PublisherController@socialLogin');
    ...
    Route::post('send-activation-mail','PublisherController@sendActivationMail');

    Route::post('check-activation-temp','PublisherController@checkActivationTemp');
    ...
    Route::post('privacy','PublisherController@privacy');
...
], function()
{
    ...
    Route::post('get_journy_spots', 'TripController@get_journy_spots');
    ...
    Route::post('edit-journey', 'TripController@editJourney');

    Route::post('delete-journey', 'TripController@deleteJourney');
...
{
    Route::post('get_countries','EventController@get_countries');
    Route::post('get_categories','EventController@get_categories');
    Route::post('get_topics','EventController@get_topics');
    Route::post('get_cities','EventController@get_cities');
    Route::post('get-event', 'EventController@get_event');
    Route::post('get-nearest-events', 'EventController@get_nearest');
    Route::post('filter', 'EventController@filter');
    Route::post('swape_join','EventController@swape_join');
    Route::post('interest','EventController@swapeInterest');
    Route::post('get_event_users','EventController@get_event_users');
